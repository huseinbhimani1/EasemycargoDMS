  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(paginatedDocs.value, (doc) => {
        _push(`<tr><td>${ssrInterpolate(doc.name)}</td><td>${ssrInterpolate(doc.layer)}</td><td>${ssrInterpolate(doc.required ? "Yes" : "No")}</td><td>${ssrInterpolate(new Date(doc.uploadedAt).toLocaleString())}</td><td><a${ssrRenderAttr("href", doc.fileUrl)} target="_blank">🔍 View</a> | <a${ssrRenderAttr("href", doc.fileUrl)} download>⬇️ Download</a> | <button>🗑️ Delete</button></td></tr>`);
      });
...
//# sourceMappingURL=all-DAk33w9A.js.map
