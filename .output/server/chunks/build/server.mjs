...
import { l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as getContext, $ as $fetch, q as createHooks, v as executeAsync, i as createError$1, x as toRouteMatcher, y as createRouter$1, z as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "user",
    path: "/user",
    component: () => import('./user-Aesc6B2m.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BqbYOuBo.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Xp7ptOmB.mjs')
  },
  {
    name: "platform",
    path: "/platform",
    component: () => import('./platform-DnOPbQYD.mjs')
  },
  {
    name: "admin-all",
    path: "/admin/all",
    component: () => import('./all-DAk33w9A.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-BhgSgtiR.mjs')
  },
  {
    name: "admin-config",
    path: "/admin/config",
    component: () => import('./config-CdA-63CW.mjs')
  },
  {
    name: "organization",
    path: "/organization",
    component: () => import('./organization-CfcgtzgB.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Coe8eBtd.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C8o1reXi.mjs'));
